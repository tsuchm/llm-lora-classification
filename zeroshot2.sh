...
poetry run python src/zeroshot2.py --output_file zeroshot2.json
poetry run python src/zeroshot2.py --output_file zeroshot2-ignore-premise.json --ignore_premise
